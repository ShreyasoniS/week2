...
function Home() {
  ...
  const fetchMusicData = async (query = '', offset = 0) => {
    ...
    try {
      ...
      setMessage('We couldnot retrieve the music data. Please try again.');
    ...
    const fetchToken = async () => {
      try {
        ...
        const response = await fetch('https://accounts.spotify.com/api/token', {
          ...
          body: 'grant_type=client_credentials&client_id=87eb862f4606402eab92f1aa219ddf84&client_secret=50fcb5d7ae42405abe6c44e20a6e17f7',
        });
        ...
        setMessage('We couldnot retrieve the token. Please try again.');
